...
public class AKnightBishopTest {
    ...
    public void canMoveToAdjacentCellTest() throws Exception {
        ...
        AKnightBishop knightbishop = new AKnightBishop(2,0,1, chessBoard.getPlayerWhite());
        chessBoard.getBoard().put(chessBoard.find_location(2,0),knightbishop);
        assertEquals(false, knightbishop.canMoveTo(chessBoard.find_location(2,0),chessBoard.find_location(3,0), chessBoard));
    ...
    public void canMoveToDiagonalCellTest() throws Exception {
        ...
        AKnightBishop knightbishop = new AKnightBishop(2,0,1, chessBoard.getPlayerWhite());
        chessBoard.getBoard().put(chessBoard.find_location(2,0),knightbishop);
        assertEquals(true, knightbishop.canMoveTo(chessBoard.find_location(2,0),chessBoard.find_location(3,1), chessBoard));
    }
    ...
    public void explore_possible_positionsAllTest() throws Exception {
        ...
        AKnightBishop knightbishop = new AKnightBishop(2,0,1, chessBoard.getPlayerWhite());
        chessBoard.getBoard().put(chessBoard.find_location(2,0),knightbishop);
        ArrayList<Location> possible_places = knightbishop.explore_possible_positions(chessBoard.find_location(2,0),chessBoard);
