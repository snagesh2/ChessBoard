...
public class RookTest {
    ...
    public void canMoveToCellIncorrectTest() throws Exception {
        ...
        Rook rook = new Rook(0,0,1, chessBoard.getPlayerWhite());
        chessBoard.getBoard().put(chessBoard.find_location(0,0),rook);
        assertEquals(false,rook.canMoveTo(chessBoard.find_location(0,0),chessBoard.find_location(2,1), chessBoard));
    ...
    public void canMoveToCellCorrectTest() throws Exception {
        ...
        Rook rook = new Rook(0,0,1, chessBoard.getPlayerWhite());
        chessBoard.getBoard().put(chessBoard.find_location(0,0),rook);
        assertEquals(true,rook.canMoveTo(chessBoard.find_location(0,0),chessBoard.find_location(6,0), chessBoard));
    }
    ...
    public void explore_possible_positionsAllTest() throws Exception {
        ...
        Rook rook = new Rook(0,0,1, chessBoard.getPlayerWhite());
        chessBoard.getBoard().put(chessBoard.find_location(0,0),rook);
        ArrayList<Location> possible_places =rook.explore_possible_positions(chessBoard.find_location(0,0),chessBoard);
